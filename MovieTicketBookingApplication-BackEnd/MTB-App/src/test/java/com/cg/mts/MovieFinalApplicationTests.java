...
//	  "/customer/add"; Customer cu=new Customer("Rajdev", "Leader", "8877885566",
//	  "rajdev@gmail.com", "raju"); String inputJson = super.mapToJson(cu);
...
//		loginController.loginUser("surya", "cap@1");
...
//		String uri = "/booking/findall";
//		MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders.get(uri)).andReturn();
//		int status = mvcResult.getResponse().getStatus();
//		assertEquals(200, status);
//		String content = mvcResult.getResponse().getContentAsString();
//		Booking bo[] = super.mapFromJson(content, Booking[].class);
//		assertEquals("Online", bo[0].getTransactionMode());
//	}
//
//	@Test
